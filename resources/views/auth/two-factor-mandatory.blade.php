...
@section('title', 'Set Up 2FA - UP STORE')
...
<div class="enable-container">
    ...
    <div class="setup-card">
        <div class="mandatory-notice">
            <div class="mandatory-notice-title">
                <svg width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-11a1 1 0 10-2 0v2H7a1 1 0 100 2h2v2a1 1 0 102 0v-2h2a1 1 0 100-2h-2V7z" clip-rule="evenodd"/>
                </svg>
                Required Security Step
            </div>
            <div class="mandatory-notice-text">
                Two-Factor Authentication (2FA) is mandatory for all accounts. This adds an extra layer of security to protect your account and transactions. You must complete this setup to continue.
            </div>
        </div>
        ...
        <div class="verification-form">
            <form method="POST" action="{{ route('2fa.setup.verify') }}">
                ...
                <button type="submit" class="btn btn-primary">Complete Setup & Continue</button>
            </form>
        </div>
    </div>
</div>
